...
public class EdibleCoinFeature {
	...
	public static int COPPER_DROP_MAXIMUM = CoinFeature.COPPER_DROP_MAXIMUM / 2;
	public static int IRON_DROP_MAXIMUM = CoinFeature.IRON_DROP_MAXIMUM / 2;
	public static int GOLD_DROP_MAXIMUM = CoinFeature.GOLD_DROP_MAXIMUM / 2;
	public static int EMERALD_DROP_MAXIMUM = CoinFeature.EMERALD_DROP_MAXIMUM + 1;
	public static int NETHERITE_DROP_MAXIMUM = CoinFeature.NETHERITE_DROP_MAXIMUM + 1;
	
	public static float COPPER_DROP_CHANCE = CoinFeature.COPPER_DROP_CHANCE + 0.1F;
	public static float IRON_DROP_CHANCE = CoinFeature.IRON_DROP_CHANCE + 0.1F;
	public static float GOLD_DROP_CHANCE =CoinFeature.GOLD_DROP_CHANCE + 0.1F;
	public static float EMERALD_DROP_CHANCE = CoinFeature.EMERALD_DROP_CHANCE + 0.05F;
	public static float NETHERITE_DROP_CHANCE = CoinFeature.NETHERITE_DROP_CHANCE + 0.005F;
