...
* Adds a craftable Receipt from an item with a currency value, like a stack of coins, and a piece of paper. _Only the paper will be consumed. The currency items will not be consumed._
